...
func (d *Daemon) Run(ctx context.Context) error {
	...
	d.ready.Store(true)
	d.logger.Debug("background loops launched (workspace-sync, task-wakeup, heartbeat, gc, auto-update, skill-sync, ambient-usage, token-renewal); health now reporting ready")
