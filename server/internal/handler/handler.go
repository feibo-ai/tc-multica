...
type Handler struct {
	...
	// Control plane (PR D, Plan 4). Optional — populated by the router
	// only when MULTICA_CONTROL_PLANE_ENABLED is true. Handlers that
	// depend on these check for nil and 503 if absent.
